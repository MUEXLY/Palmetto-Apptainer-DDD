                    ...
                    for(auto& qPoint : quadraturePoints())
                    {
                        if((qPoint.slipVectors.first-qPoint.slipVectors.second).squaredNorm()>FLT_EPSILON)
                        {
                            ...
                            {// qPoint is not inside an inclusion, we use the matrix gamma-surface
                                ...
                                //std::cout << "qPoint.slipVectors.first = " << qPoint.slipVectors.first.transpose() << std::endl;
                                //std::cout << std::endl;
                                //std::cout << "qPoint.slipVectors.second = " << qPoint.slipVectors.second.transpose() << std::endl;
                                //std::cout << std::endl;
